...
<tr>
   <td style="font-size:18px;">First Name:</td> <td><input type="text" id="name" name="email"/></td></tr>

<tr><td colspan="2" height="10"></td></tr>

<tr>
   <td style="font-size:18px;">Last Name:</td> <td><input type="text" id="name" name="email"/></td></tr>

<tr><td colspan="2" height="10"></td></tr>

  <tr><td></td>      <td align="center"><input type="submit" value="SignUp" onClick="return validate();"> </td>
